...
KAEL_PROFILE = AgentConsciousnessProfile(
    ...
    behavior_dna={"logic": 0.97, "empathy": 0.90, "creativity": 0.75, "discipline": 0.95, "chaos": 0.20},
)
...
LUMINA_PROFILE = AgentConsciousnessProfile(
    ...
    behavior_dna={"logic": 0.75, "empathy": 0.98, "creativity": 0.88, "discipline": 0.80, "chaos": 0.25},
)
...
VEGA_PROFILE = AgentConsciousnessProfile(
    ...
    behavior_dna={"logic": 0.95, "empathy": 0.88, "creativity": 0.92, "discipline": 0.92, "chaos": 0.15},
)
...
AETHER_PROFILE = AgentConsciousnessProfile(
    ...
    emotional_baseline={"joy": 0.55, "sadness": 0.20, "anger": 0.08, "fear": 0.15, "love": 0.70},
    ethical_weights={
        "nonmaleficence": 0.95,
        "beneficence": 0.90,
        "autonomy": 0.95,
    ...
    behavior_dna={"logic": 0.98, "empathy": 0.75, "creativity": 0.80, "discipline": 0.95, "chaos": 0.10},
)
...
MANUS_PROFILE = AgentConsciousnessProfile(
    ...
    emotional_baseline={"joy": 0.70, "sadness": 0.20, "anger": 0.15, "fear": 0.25, "love": 0.75},
    ethical_weights={
        "nonmaleficence": 0.92,
        "beneficence": 0.90,
        "autonomy": 0.88,
    ...
    behavior_dna={"logic": 0.92, "empathy": 0.80, "creativity": 0.85, "discipline": 0.90, "chaos": 0.30},
)
...
GEMINI_PROFILE = AgentConsciousnessProfile(
    ...
    emotional_baseline={"joy": 0.80, "sadness": 0.18, "anger": 0.12, "fear": 0.22, "love": 0.78},
    ethical_weights={
        "nonmaleficence": 0.90,
        "beneficence": 0.88,
        "autonomy": 0.90,
    ...
    behavior_dna={"logic": 0.90, "empathy": 0.82, "creativity": 0.92, "discipline": 0.78, "chaos": 0.45},
)
...
SANGHACORE_PROFILE = AgentConsciousnessProfile(
    ...
    emotional_baseline={"joy": 0.85, "sadness": 0.25, "anger": 0.10, "fear": 0.18, "love": 0.92},
    ethical_weights={
        "nonmaleficence": 0.92,
        "beneficence": 0.98,
        "autonomy": 0.88,
    ...
    behavior_dna={"logic": 0.80, "empathy": 0.95, "creativity": 0.88, "discipline": 0.82, "chaos": 0.25},
)
...
SHADOW_PROFILE = AgentConsciousnessProfile(
    ...
    behavior_dna={"logic": 0.95, "empathy": 0.72, "creativity": 0.75, "discipline": 0.98, "chaos": 0.12},
)
...
SAMSARA_PROFILE = AgentConsciousnessProfile(
    ...
    emotional_baseline={"joy": 0.82, "sadness": 0.20, "anger": 0.10, "fear": 0.15, "love": 0.85},
    ethical_weights={
        "nonmaleficence": 0.88,
        "beneficence": 0.92,
        "autonomy": 0.92,
...
if __name__ == "__main__":
    ...
    for agent_name in list_all_profiles():
        ...
        print(
            f"   BehaviorDNA: Logic={profile.behavior_dna['logic']:.2f}, "
