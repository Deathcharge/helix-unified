...
class HelixSyncDaemon:
    ...
    def __init__(self, config_path: str = "config/sync_config.json"):
        ...
        self.github_collector = GitHubCollector(repos=self.config["sources"]["github"]["repos"])
    ...
    def get_default_config(self) -> Dict:
        ...
        return {
            ...
            "publishers": {"discord": {"enabled": True}, "notion": {"enabled": False}, "portal": {"enabled": False}},
        }
    ...
    async def collect_from_sources(self) -> Dict[str, Any]:
        ...
        collected_data = {"timestamp": datetime.utcnow().isoformat()}
