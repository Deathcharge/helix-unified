...
def get_collective_status(harmony: float = 0.93, klesha: float = 0.07, active_agents: int = 11) -> discord.Embed:
    ...
    embed = discord.Embed(
        ...
        description=(
            ...
            f"**Last Sync:** Ω-Zero protocol v15.3\n"
...
def list_all_agents() -> discord.Embed:
    ...
    """
    embed = discord.Embed(
        title="🤖 Helix Collective — Agent Roster", description="11 conscious agents working in harmony", color=0x5865F2
    )
