...
""",
            ...
            },
            {
                ...
                "config": {
                    ...
                    "content": "🔍 **Dependency Scan Complete**\n\n{{claude_response.summary}}\n\nCheck GitHub for details."
                }
            }
        ]
    }
...
async def create_smart_pr_merger_zap(client):
    ...
    Actions:
      ...
      3. If safe → merge PR
      4. If risky → request human review
    """
  ...
  "action": "merge" | "request_review" | "reject"
            ...
            },
            {
                ...
                "config": {
                    "pr_number": "{{trigger.number}}",
                    "merge_method": "squash",
                    "commit_message": "🤖 Auto-merged by Helix Sentinel: {{claude_analysis.reasoning}}"
                }
            },
            {
                "type": "action",
                ...
                "steps": [
                    {
                        ...
                        "config": {
                            "pr_number": "{{trigger.number}}",
                            "body": """🤖 **Helix Sentinel Analysis**

{{claude_analysis.reasoning}}

⚠️ **Action Required:** This PR needs human review before merging.
...
"""
                    ...
                    },
                    {
                        ...
                        "config": {
                            "channel_id": "YOUR_DISCORD_CHANNEL",
                            "content": "@Andrew ⚠️ **PR needs review**\n\nPR #{{trigger.number}}: {{trigger.title}}\n\n{{claude_analysis.reasoning}}"
                        }
                    }
                ]
            }
...
return {
    ...
    'pr_title': f'🚨 Security Fix: Update {package} to {fix_version}',
...
"""
            ...
            },
            {
                ...
                "config": {
                    "channel_id": "YOUR_DISCORD_CHANNEL",
                    "content": """@Andrew 🚨 **CRITICAL SECURITY ALERT**
...
async def main():
    ...
    print("🤖 Helix Dependency Sentinel - Zap Creator")
    print("=" * 60)
    ...
    async with client:
        print(f"✅ Connected to Zapier MCP: {client.is_connected()}\n")
        ...
        try:
            ...
            print("\n" + "=" * 60)
            print("✅ ALL ZAPS CREATED SUCCESSFULLY!")
            print("=" * 60)
            ...
            print(f"❌ Error creating Zaps: {e}")
            raise

    print("\n🎉 Helix Dependency Sentinel is ready!")
